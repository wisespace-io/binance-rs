...
mod tests {
    ...
    fn get_depth() {
        ...
        assert_eq!(
            order_book.bids[0],
            Bids::new(4.00000000, 431.00000000)
        );
    }
    ...
    fn get_all_prices() {
        let mock_get_all_prices = mock("GET", "/api/v3/ticker/price")
            ...
            .with_body_from_file(
                "tests/mocks/market/get_all_prices.json",
            )
            .create();
    ...
    fn get_average_price() {
        let mock_get_average_price = mock("GET", "/api/v3/avgPrice")
            ...
            .match_query(Matcher::Regex("symbol=LTCBTC".into()))
            .with_body_from_file(
                "tests/mocks/market/get_average_price.json",
            )
            .create();
    ...
    fn get_all_book_tickers() {
        let mock_get_all_book_tickers =
            mock("GET", "/api/v3/ticker/bookTicker")
                ...
                .with_body_from_file(
                    "tests/mocks/market/get_all_book_tickers.json",
                )
                .create();
    ...
    fn get_book_ticker() {
        let mock_get_book_ticker =
            mock("GET", "/api/v3/ticker/bookTicker")
                ...
                .match_query(Matcher::Regex("symbol=LTCBTC".into()))
                .with_body_from_file(
                    "tests/mocks/market/get_book_ticker.json",
                )
                .create();
    ...
    fn get_24h_price_stats() {
        let mock_get_24h_price_stats =
            mock("GET", "/api/v3/ticker/24hr")
                ...
                .with_body_from_file(
                    "tests/mocks/market/get_24h_price_stats.json",
                )
                .create();
    ...
    fn get_all_24h_price_stats() {
        let mock_get_all_24h_price_stats =
            mock("GET", "/api/v3/ticker/24hr")
                .with_header(
                    "content-type",
                    "application/json;charset=UTF-8",
                ...
                .with_body_from_file(
                    "tests/mocks/market/get_all_24h_price_stats.json",
                )
                .create();
    ...
    fn get_klines() {
        let mock_get_klines = mock("GET", "/api/v3/klines")
            ...
            .match_query(Matcher::Regex(
                "interval=5m&limit=10&symbol=LTCBTC".into(),
            ))
        ...
        let klines =
            market.get_klines("LTCBTC", "5m", 10, None, None).unwrap();
