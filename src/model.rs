...
pub struct Bids {
    ...
    // Never serialized.
    #[serde(skip_serializing)] ignore: Vec<String>,
}
...
pub struct OrderTradeEvent {
    ...
    #[serde(rename = "i")] pub order_id: u32,
    ...
    #[serde(rename = "t")] pub trade_id: i32,

    #[serde(skip_serializing, rename = "I")] pub i_ignore: u32,
...
pub struct TradesEvent {
    ...
    #[serde(rename = "a")] pub aggregated_trade_id: u32,

    #[serde(rename = "p")] pub price: String,

    #[serde(rename = "q")] pub qty: String,

    #[serde(rename = "f")] pub first_break_trade_id: u32,

    #[serde(rename = "l")] pub last_break_trade_id: u32,
...
pub struct DayTickerEvent {
    ...
    #[serde(rename = "n")] pub num_trades: u32,
}
